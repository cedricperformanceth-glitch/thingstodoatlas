...
const buildFallbackGuide = (landmark: CityLandmark, fieldNote: string): LandmarkVisitGuide => {
  ...
  return {
    ...
    sections: [
      {
        label: '01 · THE PLACE',
        title: 'What this stop really is',
        text: landmark.description,
        note: landmark.cityContext.summary
      },
      {
        label: '02 · ROUTE',
        title: 'How to get there',
        text: gettingThere || landmark.cityContext.route
      },
      {
        label: '03 · TIME',
      ...
      {
        label: '04 · ON THE GROUND',
        title: 'How to approach it',
        text: [bestTime, whatToWear, difficulty].filter(Boolean).join(' ')
      }
    ],
    fieldNote
  };
...
export const laosLandmarkPages: LaosLandmarkPageEntry[] = [
  page(
    requireCityLandmark(pakseLandmarks, 'bolaven-plateau'),
    'pakse',
    'Pakse',
  ...
  page(
    requireCityLandmark(pakseLandmarks, 'wat-phou'),
    'pakse',
    'Pakse',
  ...
  page(
    requireCityLandmark(donDetLandmarks, 'khone-phapheng-falls'),
    'don-det',
    'Don Det',
  ...
  page(
    requireCityLandmark(donDetLandmarks, 'don-khon-railway-bridge'),
    'don-det',
    'Don Det',
  ...
  page(
    requireCityLandmark(donDetLandmarks, 'cambodia-from-don-det'),
    'don-det',
    'Don Det',
  ...
  page(
    requireCityLandmark(luangPrabangExploreLandmarks, 'pha-pa-tou'),
    'luang-prabang',
    'Luang Prabang',
  ...
  page(
    requireCityLandmark(luangPrabangExploreLandmarks, 'kuang-si-waterfall'),
    'luang-prabang',
    'Luang Prabang',
  ...
  page(
    requireCityLandmark(luangPrabangExploreLandmarks, 'slow-boat-luang-prabang-huay-xai'),
    'luang-prabang',
    'Luang Prabang',
  ...
  page(
    requireCityLandmark(thakhekLandmarks, 'kong-lor-cave'),
    'thakhek',
    'Thakhek',
  ...
  page(
    requireCityLandmark(thakhekLandmarks, 'xe-bang-fai-cave'),
    'thakhek',
    'Thakhek',
  ...
  page(
    requireCityLandmark(thakhekLandmarks, 'tham-nang-aen-cave'),
    'thakhek',
    'Thakhek',
  ...
  page(
    requireCityLandmark(vangViengLandmarks, 'hot-air-balloon-paramotor-vang-vieng'),
    'vang-vieng',
    'Vang Vieng',
  ...
  page(
    requireCityLandmark(vangViengLandmarks, 'phou-bia-from-vang-vieng'),
    'vang-vieng',
    'Vang Vieng',
